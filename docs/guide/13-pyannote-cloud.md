...
- You want the diarization stage off your CPU entirely, freeing that time and memory for transcription of the next episode.
...
Open Podlog at **http://localhost:3000/settings** and click the **Inference** tab.
