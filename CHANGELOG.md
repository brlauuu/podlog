...
The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/) and the project uses [Semantic Versioning](https://semver.org/spec/v2.0.0.html). From 1.0.0 onward, a major bump means something the operator has to act on — a removed or renamed env var, a migration that cannot be rolled back by restoring the previous dump, or a newly required external service. The `0.x` sections below predate that promise.
